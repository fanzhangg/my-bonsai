// Shared planter vocabulary for adoption and the design-system preview.
export const TONES = [
...
export function normalizePot(pot){
  if(!pot||typeof pot!=='object'||Array.isArray(pot))return undefined;
...
export function potMarkup({shape='oval',tone='sand',pattern='plain'}={},x=0,y=0,id='planter',{dynamic=true}={}){
  ...
  const t={body:material('vessel-body',base.body),rim:material('vessel-rim',base.rim),ink:material('vessel-pattern',base.ink)};
